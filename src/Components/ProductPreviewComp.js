...
export default function ProductPreviewComp({data}) {
    const urlLink1 = {pdfFile: data?.pdfFile?.url}
const encodedUrlLink = encodeURIComponent(JSON.stringify(urlLink1));
  return (
    <div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 mx-auto max-md:px-2 ">
                <div class="img">
                    <div class="img-box h-full max-lg:mx-auto ">
                        <img src={data?data?.cover_image?.url:"https://pagedone.io/asset/uploads/1700471600.png"} alt="Yellow Tropical Printed Shirt image"
